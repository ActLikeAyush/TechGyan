            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="profile.jsp"><span class="fa fa-at"></span>Learn Code</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                             ...
                             <div class="row my-3 row-user">
                                 <div class="col-md-8">
                                     <!--fetching user name form data base-->
                                     <%
                                         UserDao ud=new UserDao(ConnectionProvider.getConnection());
                                         ud.getUserByUserId(p.getUserId());
                                     %>
                                     
                                     <p class="post-user-info"> <a href="#!" > <%= ud.getUserByUserId(p.getUserId()).getName() %> </a> has posted..</p>
                                 </div>
                                 <div class="col-md-4">
                                     <p class="post-date"><%= p.getpDate().toGMTString() %></p>
                                 </div>
                             </div>
                        ...
                        <div class="card-footer banner-background">
                            <%
                            LikeDao ld=new LikeDao(ConnectionProvider.getConnection());
                            %>
                            
                            
                            <a href="#!" onclick="doLike(<%=p.getPid()%>,<%=user.getId()%>)" class=" btn-outline-primary btn-l "  style="margin-right: 10px;color: red"><i class="fa fa-heart" ></i><span class="like-counter"><%=ld.countLikeOnPost(p.getPid())%></span></a>
